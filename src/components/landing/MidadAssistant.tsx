...
/** ردود ذكية مبسّطة حسب الكلمات المفتاحية (عرض تعريفي لمساعد مِداد). */
function reply(q: string): string {
  ...
  if (/ابدأ|بداية|تسجيل|حساب|كيف/.test(t))
  ...
  if (/تعليم|حلق|قرآن|طلاب|حفظ/.test(t))
  ...
  return 'أنا مساعد مِداد الذكي، أساعدك في التعرّف على المنصّة وأنظمتها وباقاتها. اسألني عن أي شيء، أو سجّل الدخول لتجربة المساعد الكامل داخل مؤسستك.';
}
