  ...
  return (
    <>
      <div className="org-panel" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap' }}>
        <div>
          <strong style={{ color: 'var(--purple-900)', fontFamily: 'var(--font-display)' }}>تسجيل الخروج</strong>
          <p className="org-panel-sub" style={{ margin: '0.25rem 0 0' }}>إنهاء جلستك الحالية على هذا الجهاز.</p>
        </div>
        ...
        <div className="org-modal-scrim" onClick={() => setConfirm(false)}>
          <div className="org-modal" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true">
            ...
            <div className="org-modal-actions">
              <button className="org-btn org-btn-outline" onClick={() => setConfirm(false)} disabled={busy}>إلغاء</button>
